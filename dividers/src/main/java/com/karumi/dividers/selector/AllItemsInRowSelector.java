...
/**
 * Selector that applies to all the items in a single row equally.
 */
public class AllItemsInRowSelector implements Selector {

  protected final int row;

  public AllItemsInRowSelector(int row) {
    this.row = row;
  }
